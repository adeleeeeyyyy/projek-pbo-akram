...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        <div class="container">
            <a class="navbar-brand" href="/">FEROZ MUSIC STORE</a>
        ...
        <div class="row justify-content-center">
            <div class="col-md-7">
                <div class="form-container mb-5">
                    <h2>TAMBAHKAN INSTRUMEN BARU</h2>
                    ...
                    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Contoh: Fender Stratocaster" value="{{ old('name') }}" required>
                        </div>
